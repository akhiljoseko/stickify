...
///
/// Import this single file to access all core utilities:
/// ```dart
...
export 'presentation/shared/adaptive_sheet.dart';
export 'presentation/shared/blocking_error_dialog.dart';
